...
1. 最大公约数，**欧几里德算法**
2. 最小公倍数
3. 打印四种蛇形数组，顺时针，逆时针，Z，倒 Z。[参考](https://blog.csdn.net/Echo_Ana/article/details/53411476)
4. 素数筛，算法需要好好看看 王道指南 P96
5. 素因数分解，多写几遍 P98
6. 二分求幂 P103
