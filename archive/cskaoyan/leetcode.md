...
1. 有些题目虽然描述起来让人觉得很难，但是看到问题的本质后就不难了，如 561
...
这题解法上有语言上的陷阱，**队列 qt 在 for 循环中是不断变化的，不能在 for() 中取 q.size()**，会的到意外的结果。
